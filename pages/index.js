  ...
  return (
    <div>
        <div className="">
            ...
            <Script src="scripts/particle-settings.js" />            

            <div id="top" className="theme-particles">
                <div id="preloader">
                    <div id="loader"></div>
                </div>
                ...
                <div className="s-pagewrap">
                    <header className="s-header">
                        <div className="row s-header__content">
                            ...
                            <div className="s-header__logo">
                                <a className="logo" href="index-particles.html">
                                    <Image src="/vercel.svg" alt="Homepage" width="100" height ="100"/>
                                </a>
                            </div>
                    ...
                    <section id="intro" className="s-intro">
                        ...
                        <div id="particles-js" className="s-intro__particles"></div>
                            ...
                            <div className="column lg-12">
                                ...
                                <div className="counter">
                                    <div className="counter__time">
                                        <span className="ss-days">365</span>
                                        <span>days</span>
                                    </div>
                                    <div className="counter__time">
                                            ...
                                            <div className="column">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="column lg-6 tab-12">
                                                        ...
                                                        <a href="https://www.dreamhost.com/r.cgi?287326" className="btn btn--primary u-fullwidth">Get Started Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                                            ...
                                            <div className="column services-list__item">
                                                <div className="services-list__item-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill:'rgba(0, 0, 0, 1)' }}><path d="M12,6c-3.309,0-6,2.691-6,6s2.691,6,6,6s6-2.691,6-6S15.309,6,12,6z M12,16c-2.206,0-4-1.794-4-4s1.794-4,4-4s4,1.794,4,4 S14.206,16,12,16z"></path><path d="M12,2C6.579,2,2,6.579,2,12s4.579,10,10,10s10-4.579,10-10S17.421,2,12,2z M12,20c-4.337,0-8-3.663-8-8s3.663-8,8-8 s8,3.663,8,8S16.337,20,12,20z"></path><path d="M12,10c-1.081,0-2,0.919-2,2s0.919,2,2,2s2-0.919,2-2S13.081,10,12,10z"></path></svg>
                                                </div>
                                            ...
                                            <div className="column services-list__item">
                                                <div className="services-list__item-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill:'rgba(0, 0, 0, 1)' }}><path d="M19,3H5C3.897,3,3,3.897,3,5v14c0,1.103,0.897,2,2,2h14c1.103,0,2-0.897,2-2V5C21,3.897,20.103,3,19,3z M19,5l0.001,4H15h-2 H5V5H19z M5,11h8v8H5V11z M15,19v-8h4.001l0.001,8H15z"></path></svg>
                                                </div>
                                                <div className="services-list__item-content">
                                        ...
                                        <div className="row">
                                            <div className="column">
                                                ...
                                                <form id="mc-form" className="mc-form">
                                                    <input type="email" name="EMAIL" id="mce-EMAIL" className="u-fullwidth text-center" placeholder="Email Address" title="The domain portion of the email address is invalid (the portion after the @)." pattern="^([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22))*\x40([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d))*(\.\w{2,})+$" required />
                        ...
                        <div className="row s-footer__bottom">
                            ...
                            <div className="ss-go-top">
                                <a className="smoothscroll" title="Back to Top" href=" top">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill:'rgba(0, 0, 0, 1)' }}><path d="M6 4H18V6H6zM11 14L11 20 13 20 13 14 18 14 12 8 6 14z"></path></svg>
                                </a>
                            </div>
                        </div>  
                    </footer>  
